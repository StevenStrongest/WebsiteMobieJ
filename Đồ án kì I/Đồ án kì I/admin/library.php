...
define("SMTP_UNAME", "ducmanhdv@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "manhdaica2001"); //Password for SMTP authentication
