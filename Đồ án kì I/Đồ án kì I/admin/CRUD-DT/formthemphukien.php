 ...
 <?php include('menu.php'); ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Thêm mới sản phẩm(Phụ kiện)</h1>
            <a href="../danhsachphukien.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i style="margin-right: 5px" class="fas fa-chevron-left text-white-50"></i></i>Quay lại danh sách phụ kiện</a>
          </div>        
      </div>
      
      <!-----------Form thêm sản phẩm---------------->
		<div class="container">
      <form method="post" id="them_dt" action="xulythemphukien.php" onsubmit="return validate();" id="them_dt" enctype="multipart/form-data">
				<div class="row">
          <!--------Row-left------>
            ...
            <!----Tên sản phẩm------->
              ...
              <input type="text" onfocusout="validate_ten_dt()" id="ten_dt" placeholder="Nhập tên sản phẩm" name="ten_dt">
              <span class="helper-text"></span>
              <br><span><b>Mô tả ngắn</b></span><br>
              <textarea cols="82" rows="7" name="nd" ></textarea>
              <br><span><b>Mô tả chi tiết</b></span><br>
              <textarea cols="82" rows="20" name="mo_ta" id="editor" ></textarea>
						</div>           
            <!------Ảnh sản phẩm---------->
            <div class="img_main">
              <h5>Ảnh sản phẩm</h5>
          ...
          <div class="col-md-4 col-lg-4 col-sm-4">
            <div class="trang_thai">
              <h5>Số lượng trong kho</h5>
                <input style="width: 100%;border-radius: 5px;border: 1px solid silver;padding: 0px 10px" type="number" required="true" name="sl">
            </div>
            <!--------Danh mục sản phẩm------>
            <div class="danh_muc">
              <select id="danh_muc" name="danh_muc" class="form-control form-control-sm">
             ...
             <div class="row">
               <div class="col-md-12 col-sm-12 col-lg-12">
                 ...
                 <div class="input-group mb-3">
                  <input type="text" id="gia_goc" name="gia_goc" onfocusout="validate_gia_sp()" class="form-control format" placeholder="0">
