  ...
  <?php include('menu.php') ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Cập nhật sản phẩm(Phụ kiện)</h1>
            <a href="../danhsachphukien.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i style="margin-right: 5px" class="fas fa-chevron-left text-white-50"></i></i>Quay lại danh sách sản phẩm</a>
          </div>        
      </div>
      <?php 
        include('../../connect.php');
      ...
      ?>
           <!-----------Form thêm sản phẩm---------------->
    <div class="container">
      <form id="them_dt" method="post" action="xulysuapk.php" onsubmit="return validate();" enctype="multipart/form-data">
        <div class="row">
          <!--------Row-left------>
          <div class="col-md-8 col-lg-8 col-sm-8">
            ...
            <div class="ten_sp">
              ...
              <input type="text" onfocusout="validate_ten_dt()" placeholder="Nhập tên sản phẩm" value="<?=$dt['ten_phu_kien']?>" id=ten_dt name="ten_dt">
               <span class="helper-text"></span><br>
               <br><span><b>Mô tả ngắn</b></span><br>
              <textarea cols="82" rows="7" name="nd" ><?=$dt['mo_ta']?></textarea>
              <input style="display: none;" type="text" value="<?=$dt['ma_phu_kien']?>" id=ten_dt name="ma">
              <span><b>Nội dung </b></span><br>
              <textarea name="mo_ta" cols="82" rows="20" id="editor" ><?=$dt['mo_ta_ct']?></textarea>
            </div>           
            <!------Ảnh sản phẩm---------->
            <div class="img_main">
              <h5>Ảnh sản phẩm</h5>
          ...
          <div class="col-md-4 col-lg-4 col-sm-4">
            <div class="trang_thai">
              ...
              <?php if($tt > 0){
              ?>
                <input type="radio" readonly="true" checked="true" value="1" name="tt"><span>Còn hàng</span><br>
              <?php 
              }else{
              ?>
                <input type="radio" readonly="true" checked="true" value="0" name="tt"><span>Hết hàng</span>
              <?php 
              }
              ?>
             ...
             <div class="row">
               <div class="col-md-12 col-sm-12 col-lg-12">
                 ...
                 <div class="input-group mb-3">
                  <input onfocusout="validate_gia_sp()" id="gia_goc" name="gia_goc" type="text" value="<?=number_format($dt['gia_goc_pk'],0,'.',',')?>" class="form-control format" placeholder="0">
               ...
               <div class="col-md-12 col-sm-12 col-lg-12">
                 ...
                 <div class="input-group mb-3">
                  <input name="gia_khuyen_mai" id="gia_khuyen_mai" value="<?=number_format($dt['gia_khuyen_mai_pk'],0,'.',',')?>" type="text" class="form-control format" placeholder="0">
                  <div class="input-group-append">
        ...
        <div style="width: 100%;height: 1px;margin-top: 20px;background: silver" class="k"></div>
           <!-------Điều khiển-------> 
              <div class="dieu_khien">
                  <a href="../danhsachphukien.php"><button type="button">Hủy</button></a>
