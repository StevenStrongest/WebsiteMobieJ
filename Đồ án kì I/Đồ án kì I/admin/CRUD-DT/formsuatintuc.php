...
<body id="page-top">
  ...
  <?php include('menu.php') ?>
      ...
      <form id="them_dt" method="post" action="xulysuatintuc.php" enctype="multipart/form-data">
				<div class="row">
          <!--------Row-left------>
            ...
            <!----Tên sản phẩm------->
              ...
              <input type="text" placeholder="Nhập tiêu đề" onfocusout="validate_ten_dt()" value="<?=$tt['tieu_de']?>" id=ten_dt name="tieu_de">
              <input style="display: none;" type="text" value="<?=$tt['id_tin_tuc']?>"  name="id">
               <span class="helper-text"></span>
               <br><span><b>Mô tả ngắn</b></span><br>
              <textarea style="width: 100%;min-height: 100px;overflow-y: auto;" name="mo_ta_ngan"><?=$tt['mo_ta_ngan']?></textarea>
              <br><span><b>Nội dung</b></span><br>
              <textarea name="mo_ta" cols="82" rows="20" id="editor" ><?=$tt['noi_dung_chi_tiet']?></textarea>
						</div>           
            <!------Ảnh sản phẩm---------->
            <div class="img_main">
              ...
              <div class="khung_chua khung_chua_tt">
                <img style="width: 100%;" src="../../images/<?=$tt['anh_tieu_de']?>">
              </div>
              <div class="chon_tt">
                <div class="choose">
