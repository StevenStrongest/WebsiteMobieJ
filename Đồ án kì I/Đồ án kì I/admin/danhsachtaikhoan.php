 ...
 <?php include('menu.php'); ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Danh sách tài khoản quản trị</h1>
            <a href="CRUD-DT/formthemthanhvien.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Thêm thành viên</a>
          </div>        
      </div>
      <!-- Danh tài khoản-->
       ...
       <!------Thống kê------------->
      <div class="container">
        <form id="thongke" method="post" action="danhsachtaikhoan.php">
          <div class="row">
            <div class="col-md-3">
              <span>Chọn ngày</span>
      ...
      <div class="container-fluid">
        <div class="ds_sp">
            <table class="table table-striped">
			    ...
			    <tbody>
			      <?php include('file-hien-thi/hienthitaikhoan.php'); ?>
			    </tbody>
			  </table>
        </div>
      </div>
