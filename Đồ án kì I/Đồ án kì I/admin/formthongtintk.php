...
<body>
	...
	$id = $_SESSION['id'];
		...
		$update = "update thong_tin_tai_khoan set ho='$ho', ten='$ten', email='$email', sdt=$sdt,dia_chi='$dia_chi',avatar='$avatar' where id=$id";
	...
	<div class="all">
		<div class="container">
			...
			<div style="text-align: center;" class="text">
				<p style="margin-bottom: 3px"><b style="font-size: 50px">Cập nhật thông tin</b></p>
				<p>Tất cả thông tin liên quan đến tài khoản</p>
			</div>
			<hr>
			<!-----Form thông tin------>
			<div class="thong_tin">
				<form method="post" action="formthongtintk.php" id="thong_tin_tk" class="myform" enctype="multipart/form-data">
					<div class="ho_ten">
						<div class="row">
							<div class="col-md-6 col-lg-6 col-sm-6">
								<span><b>Họ</b></span><br>
								<input value="<?=$tt['ho']?>" type="text" name="ho">
							</div>
							<div class="col-md-6 col-lg-6 col-sm-6">
								<span><b>Tên</b></span><br>
								<input value="<?=$tt['ten']?>" type="text" name="ten">
							</div>
						</div>
					</div>
					<div style="margin-top: 10px;" class="email_dt">
						<div class="row">
							<div class="col-md-6 col-lg-6 col-sm-6">
								...
								<input type="text" value="<?=$tt['email']?>"  name="email">
							</div>
							<div class="col-md-6 col-lg-6 col-sm-6">
								<span><b>Số điện thoại</b></span><br>
								<input type="text" value="<?=$tt['sdt']?>" name="sdt">
							</div>
						</div>
					</div>
					<div style="margin-top: 10px" class="dia_chi">
						<span><b>Địa chỉ</b></span><BR>
						<input type="text" value="<?=$tt['dia_chi']?>" name="dia_chi">
					</div>
					<hr>
					<p><b>CHI TIẾT</b></p>
					<div class="gioi_thieu">
						<span>Thông tin giới thiệu(Tùy chọn)</span><br>
						<textarea rows="7" cols="112"></textarea>
					</div>
					<hr>
					<div style="text-align: center;" class="avatar">
						...
						<div style="width: 300px;height: 300px;border: 1px solid silver;display: inline-block;text-align: center;" class="khung">
							<?php 
								if($tt['avatar'] != ""){
							?>
								<img style="width: 100%;height: 100%;" src="../images/<?=$tt['avatar']?>">
							<?php 
							}
							?>
						</div><br>
