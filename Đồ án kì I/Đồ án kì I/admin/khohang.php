  ...
  <?php include('menu.php'); ?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Kho hàng điện thoại</h1>           
          </div>        
      </div>
      <!-- Danh sách sản phẩm-->
        ...
        <div class="ds_sp">
            <table class="table table-striped">
              ...
              <tbody>
                <?php include('file-hien-thi/hienthikhohangdt.php') ?>
              </tbody>
             </table>
        </div>
      </div>
...
<!---Phân trang----->
    ...
    <ul class="pagination">
      ...
      if($tranghientai > 1){
        $pre = $tranghientai - 1;
    ?>
      <li class="page-item"><a class="page-link" href="khohang.php?tranghientai=<?=$pre?>"> < </a></li>
    <?php 
    }
    ?>
     ...
     ?>
      <li class="page-item"><a class="page-link" href="khohang.php?tranghientai=<?php echo $i?>"><?=$i?></a></li>
    <?php
         }
      }
     }
    ...
    <?php 
      if($tranghientai < $tongsotrang - 2){
        $next = $tranghientai + 3;
    ?>
      <li class="page-item"><a class="page-link" href="khohang.php?tranghientai=<?=$next?>"> > </a></li>
    <?php
    }
     ?>
   </ul>
