        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Danh sách sản phẩm</h1>
               ...
               <a href="CRUD-DT/formthemphukien.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Thêm sản phẩm</a>
        ...
        <div class="ds_sp">
          <form>
            <table style="font-size: 15px;" class="table table-striped">
              ...
              <tbody>
                <?php include('file-hien-thi/hienthiphukien.php') ?>
              </tbody>
             </table>
          </form>
        </div>
