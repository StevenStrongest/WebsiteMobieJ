        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Danh sách sản phẩm</h1>           
               <a href="CRUD-DT/formthemtintuc.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i>Thêm tin tức</a>
          </div>        
      </div>
      <!-- Danh sách sản phẩm-->
        ...
        <div class="ds_sp">
          <form>
            <table class="table table-striped">
              ...
              <tbody>
                <?php include('file-hien-thi/hienthitintuc.php') ?>
              </tbody>
             </table>
          </form>
        </div>
